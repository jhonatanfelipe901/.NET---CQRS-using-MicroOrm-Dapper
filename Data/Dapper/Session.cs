...
namespace CQRSWithDapper.Data.Dapper
{
	public class Session : ISession
	{
		private readonly IDapperContext _context;

		public Session(string connectionString) => _context = new DapperContext(connectionString);

		public Session(IDapperContext context) => _context = context;
